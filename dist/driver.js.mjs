...
function fe(e, o, t, i) {
  ...
  const n = d || t.getBoundingClientRect(), v = i.getBoundingClientRect(), w = O(e, n.x, v.x - n.x, o), r = O(e, n.y, v.y - n.y, o), f = O(e, n.width, v.width - n.width, o), g = O(e, n.height, v.height - n.height, o);
  d = {
    x: w,
    y: r,
    width: f,
...
function ie(e) {
  const o = window.innerWidth, t = window.innerHeight, i = s("stagePadding") || 0, d = s("stageRadius") || 0, n = e.width + i * 2, v = e.height + i * 2, w = Math.min(d, n / 2, v / 2), r = Math.floor(Math.max(w, 0)), f = e.x - i + r, g = e.y - i, y = n - r * 2, a = v - r * 2;
  return `M${o},0L0,0L0,${t}L${o},${t}L${o},0Z
    M${f},${g} h${y} a${r},${r} 0 0 1 ${r},${r} v${a} a${r},${r} 0 0 1 -${r},${r} h-${y} a${r},${r} 0 0 1 -${r},-${r} v-${a} a${r},${r} 0 0 1 ${r},-${r} z`;
}
function me() {
...
function be(e, o) {
  var C;
  const i = Date.now(), d = l("__activeStep"), n = l("__activeElement") || e, v = !n || n === e, w = e.id === "driver-dummy-element", r = n.id === "driver-dummy-element", f = s("animate"), g = o.onHighlightStarted || s("onHighlightStarted"), y = (o == null ? void 0 : o.onHighlighted) || s("onHighlighted"), a = (d == null ? void 0 : d.onDeselected) || s("onDeselected"), p = s(), c = l();
  !v && a && a(r ? void 0 : n, d, {
    config: p,
    state: c,
    driver: _()
...
function Pe(e) {
  ...
  const i = l("__activeElement"), d = (r = l("popover")) == null ? void 0 : r.wrapper, n = U([
    ...d ? [d] : [],
    ...i ? [i] : []
  ]), v = n[0], w = n[n.length - 1];
  if (e.preventDefault(), e.shiftKey) {
    const f = n[n.indexOf(document.activeElement) - 1] || w;
    f == null || f.focus();
  } else {
    const f = n[n.indexOf(document.activeElement) + 1] || v;
    f == null || f.focus();
  }
}
function ne(e) {
...
function re(e, o, t) {
  const i = (v, w) => {
    const r = v.target;
    e.contains(r) && ((!t || t(r)) && (v.preventDefault(), v.stopPropagation(), v.stopImmediatePropagation()), w == null || w(v));
  }, n = { capture: !0, passive: !1 };
  document.addEventListener("pointerdown", i, n), document.addEventListener("mousedown", i, n), document.addEventListener("pointerup", i, n), document.addEventListener("mouseup", i, n), document.addEventListener(
    "click",
    (v) => {
      i(v, o);
    },
...
function Q(e, o) {
  ...
  const {
    ...
    prevBtnText: f = s("prevBtnText") || "&larr; Previous",
    progressText: g = s("progressText") || "{current} of {total}"
  } = o.popover || {};
  t.nextButton.innerHTML = r, t.previousButton.innerHTML = f, t.progress.innerHTML = g, i ? (t.title.innerHTML = i, t.title.style.display = "block") : t.title.style.display = "none", d ? (t.description.innerHTML = d, t.description.style.display = "block") : t.description.style.display = "none";
...
function ae(e, o) {
  ...
  if (!t)
    return;
  const { align: i = "start", side: d = "left" } = (o == null ? void 0 : o.popover) || {}, n = i, v = e.id === "driver-dummy-element" ? "over" : d, w = s("stagePadding") || 0, r = se(), f = t.arrow.getBoundingClientRect(), g = e.getBoundingClientRect(), y = g.top - r.height;
  let a = y >= 0;
  ...
  const C = !a && !c && !h && !x;
  let S = v;
  if (v === "top" && a ? x = h = c = !1 : v === "bottom" && c ? x = h = a = !1 : v === "left" && h ? x = a = c = !1 : v === "right" && x && (h = a = c = !1), v === "over") {
...
function Ee(e, o, t) {
  ...
  if (!i)
    return;
  const d = t.getBoundingClientRect(), n = se(), v = i.arrow, w = n.width, r = window.innerWidth, f = d.width, g = d.left, y = n.height, a = window.innerHeight, p = d.top, c = d.height;
  v.className = "driver-popover-arrow";
  let u = o, h = e;
  if (o === "top" ? (g + f <= 0 ? (u = "right", h = "end") : g + f - w <= 0 && (u = "top", h = "start"), g >= r ? (u = "left", h = "end") : g + w >= r && (u = "top", h = "end")) : o === "bottom" ? (g + f <= 0 ? (u = "right", h = "start") : g + f - w <= 0 && (u = "bottom", h = "start"), g >= r ? (u = "left", h = "start") : g + w >= r && (u = "bottom", h = "end")) : o === "left" ? (p + c <= 0 ? (u = "bottom", h = "end") : p + c - y <= 0 && (u = "left", h = "start"), p >= a ? (u = "top", h = "end") : p + y >= a && (u = "left", h = "end")) : o === "right" && (p + c <= 0 ? (u = "bottom", h = "start") : p + c - y <= 0 && (u = "right", h = "start"), p >= a ? (u = "top", h = "start") : p + y >= a && (u = "right", h = "end")), !u)
    v.classList.add("driver-popover-arrow-none");
  else {
    v.classList.add(`driver-popover-arrow-side-${u}`), v.classList.add(`driver-popover-arrow-align-${h}`);
    const m = t.getBoundingClientRect(), x = v.getBoundingClientRect(), C = s("stagePadding") || 0, S = m.left - C < window.innerWidth && m.right + C > 0 && m.top - C < window.innerHeight && m.bottom + C > 0;
    o === "bottom" && S && (x.x > m.x && x.x + x.width < m.x + m.width ? i.wrapper.style.transform = "translateY(0)" : (v.classList.remove(`driver-popover-arrow-align-${h}`), v.classList.add("driver-popover-arrow-none"), i.wrapper.style.transform = `translateY(-${C / 2}px)`));
  }
}
function Le() {
  ...
  return f.type = "button", f.classList.add("driver-popover-next-btn"), f.innerHTML = "Next &rarr;", w.appendChild(r), w.appendChild(f), n.appendChild(v), n.appendChild(w), e.appendChild(d), e.appendChild(o), e.appendChild(t), e.appendChild(i), e.appendChild(n), {
    wrapper: e,
    arrow: o,
    title: t,
    description: i,
...
function Ae(e = {}) {
  ...
  function r() {
    l("isInitialized") || (k("isInitialized", !0), document.body.classList.add("driver-active", s("animate") ? "driver-fade" : "driver-simple"), ke(), N("overlayClick", t), N("escapePress", o), N("arrowLeftPress", v), N("arrowRightPress", w));
  }
  function f(a = 0) {
    var $, B, R, W, V, q, K, Y;
    const p = s("steps");
